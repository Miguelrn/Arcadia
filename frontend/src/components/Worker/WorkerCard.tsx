        ...
        <Card sx={{ border: (props.hasJob) ? '1px solid green' : '1px solid red' }}>
                ...
                <Grid container justifyContent={'space-between'} direction={'row'}>
                    ...
                    <Grid item xs={5}>
                        <Typography gutterBottom variant="h6" component="div">
                            <CakeIcon/>{moment(props.birthdate).format('YYYY/MM/DD')}
                        </Typography>
                        <Typography gutterBottom variant="caption" component="div">
                            <TransgenderIcon/>{props.gender}
                        </Typography>
                    </Grid> 
            ...
            <CardActions>
                <Grid container justifyContent={'space-between'} direction={'row'} alignContent={'center'}>
                    <Grid item><PhoneAndroidIcon />{props.phone.split('x')[0]} </Grid>
                    <Grid item><EmailIcon />{props.email}</Grid>
                </Grid>
            </CardActions>
        </Card>
    </>
